...
{
    /// <inheritdoc />
    public partial class _initializeDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FixedAssets_Equipments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HRM_Department", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentDesignationId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HRM_Designation", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "HRM_EmployeeCategory",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HRM_EmployeeCategory", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "HRM_EmployeeType",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HRM_EmployeeType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BloodGroup = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HRM_Employees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HRM_Employees_HRM_Department_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "HRM_Department",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HRM_Employees_HRM_Designation_DesignationId",
                        column: x => x.DesignationId,
                        principalTable: "HRM_Designation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HRM_Employees_HRM_EmployeeCategory_EmployeeCategoryId",
                        column: x => x.EmployeeCategoryId,
                        principalTable: "HRM_EmployeeCategory",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HRM_Employees_HRM_EmployeeType_EmployeeTypeId",
                        column: x => x.EmployeeTypeId,
                        principalTable: "HRM_EmployeeType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HRM_Attendance", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HRM_Attendance_HRM_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HRM_EmployeeAddress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HRM_EmployeeAddress_AddressType_AddressTypeId",
                        column: x => x.AddressTypeId,
                        principalTable: "AddressType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HRM_EmployeeAddress_HRM_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "HRM_Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HRM_EmployeeAddress_Upazila_UpazilaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HRM_Attendance_EmployeeId",
                table: "HRM_Attendance",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_HRM_EmployeeAddress_AddressTypeId",
                table: "HRM_EmployeeAddress",
                column: "AddressTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_HRM_EmployeeAddress_EmployeeId",
                table: "HRM_EmployeeAddress",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_HRM_EmployeeAddress_UpazilaId",
                table: "HRM_EmployeeAddress",
                column: "UpazilaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HRM_Employees_DesignationId",
                table: "HRM_Employees",
                column: "DesignationId");

            migrationBuilder.CreateIndex(
                name: "IX_HRM_Employees_EmployeeCategoryId",
                table: "HRM_Employees",
                column: "EmployeeCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_HRM_Employees_EmployeeTypeId",
                table: "HRM_Employees",
