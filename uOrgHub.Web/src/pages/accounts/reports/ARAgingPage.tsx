        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              <th data-col="customer" className="text-left px-4 py-2.5 text-xs font-medium text-gray-500">Customer</th>
              <th data-col="invoice" className="text-left px-4 py-2.5 text-xs font-medium text-gray-500">Invoice #</th>
          ...
          <tbody>
            {rows.map((row, i) => (
              <tr key={i} className="border-b border-gray-100 hover:bg-gray-50/50">
                <td data-col="customer" className="px-4 py-2 text-sm">{row.customerOrVendor}</td>
                <td data-col="invoice" className="px-4 py-2 text-xs font-mono text-gray-500">{row.documentNumber}</td>
