...
{
    /// <inheritdoc />
    public partial class AddCivilEngineeringModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DrawnById = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_proj_drawings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_proj_drawings_proj_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "proj_projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_proj_drawings_proj_wbs_WBSId",
                        column: x => x.WBSId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    WBSId = table.Column<Guid>(type: "uuid", nullable: true),
                    NCRNumber = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Title = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    ...
                    ResponsibleParty = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_proj_ncrs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_proj_ncrs_proj_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "proj_projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_proj_ncrs_proj_wbs_WBSId",
                        column: x => x.WBSId,
                        principalTable: "proj_wbs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                name: "proj_qa_checklists",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    WBSId = table.Column<Guid>(type: "uuid", nullable: true),
                    ChecklistNumber = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Title = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    ...
                    InspectedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_proj_qa_checklists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_proj_qa_checklists_proj_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "proj_projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_proj_qa_checklists_proj_wbs_WBSId",
                        column: x => x.WBSId,
                        principalTable: "proj_wbs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillSequence = table.Column<int>(type: "integer", nullable: false),
                    SubmittedById = table.Column<Guid>(type: "uuid", nullable: false),
                    CertifiedById = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    RetentionPercent = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    ...
                    PreviousBilledAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    CumulativeBilledAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    Notes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_proj_ra_bills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_proj_ra_bills_proj_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "proj_projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "proj_resource_allocations",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    EquipmentCode = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ...
                    PlannedCost = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_proj_resource_allocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_proj_resource_allocations_proj_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "proj_projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_proj_resource_allocations_proj_wbs_WBSId",
                        column: x => x.WBSId,
                        principalTable: "proj_wbs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    WBSId = table.Column<Guid>(type: "uuid", nullable: true),
                    RFINumber = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Subject = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    Description = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    RaisedById = table.Column<Guid>(type: "uuid", nullable: false),
                    RaisedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    AssignedToId = table.Column<Guid>(type: "uuid", nullable: true),
                    ResponseDueDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_proj_rfis", x => x.Id);
                    table.ForeignKey(
                        name: "FK_proj_rfis_proj_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "proj_projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_proj_rfis_proj_wbs_WBSId",
                        column: x => x.WBSId,
                        principalTable: "proj_wbs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Severity = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    InjuredPersonName = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    InjuryType = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    InvestigationDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ClosedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_proj_safety_incidents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_proj_safety_incidents_proj_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "proj_projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "proj_submittals",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    SubmittalNumber = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Title = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    ContractorReference = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_proj_submittals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_proj_submittals_proj_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "proj_projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_proj_qa_checklist_items", x => x.Id);
                    table.ForeignKey(
                        name: "FK_proj_qa_checklist_items_proj_qa_checklists_ChecklistId",
                        column: x => x.ChecklistId,
                        principalTable: "proj_qa_checklists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "proj_ra_bill_items",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    RABillId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_proj_ra_bill_items", x => x.Id);
                    table.ForeignKey(
                        name: "FK_proj_ra_bill_items_proj_boq_items_BOQItemId",
                        column: x => x.BOQItemId,
                        principalTable: "proj_boq_items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_proj_ra_bill_items_proj_ra_bills_RABillId",
                        column: x => x.RABillId,
                        principalTable: "proj_ra_bills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_proj_drawings_ProjectId_DrawingNumber_Revision",
                table: "proj_drawings",
                columns: new[] { "ProjectId", "DrawingNumber", "Revision" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_proj_drawings_WBSId",
                table: "proj_drawings",
                column: "WBSId");

            migrationBuilder.CreateIndex(
                name: "IX_proj_ncrs_ProjectId_NCRNumber",
                table: "proj_ncrs",
                columns: new[] { "ProjectId", "NCRNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_proj_ncrs_WBSId",
                table: "proj_ncrs",
                column: "WBSId");

            migrationBuilder.CreateIndex(
                name: "IX_proj_qa_checklist_items_ChecklistId",
                table: "proj_qa_checklist_items",
                column: "ChecklistId");

            migrationBuilder.CreateIndex(
                name: "IX_proj_qa_checklists_ProjectId_ChecklistNumber",
                table: "proj_qa_checklists",
                columns: new[] { "ProjectId", "ChecklistNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_proj_qa_checklists_WBSId",
                table: "proj_qa_checklists",
                column: "WBSId");

            migrationBuilder.CreateIndex(
                name: "IX_proj_ra_bill_items_BOQItemId",
                table: "proj_ra_bill_items",
                column: "BOQItemId");

            migrationBuilder.CreateIndex(
                name: "IX_proj_ra_bill_items_RABillId",
                table: "proj_ra_bill_items",
                column: "RABillId");

            migrationBuilder.CreateIndex(
                name: "IX_proj_ra_bills_ProjectId_BillNumber",
                table: "proj_ra_bills",
                columns: new[] { "ProjectId", "BillNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_proj_resource_allocations_ProjectId",
                table: "proj_resource_allocations",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_proj_resource_allocations_WBSId",
                table: "proj_resource_allocations",
                column: "WBSId");

            migrationBuilder.CreateIndex(
                name: "IX_proj_rfis_ProjectId_RFINumber",
                table: "proj_rfis",
                columns: new[] { "ProjectId", "RFINumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_proj_rfis_WBSId",
                table: "proj_rfis",
                column: "WBSId");

            migrationBuilder.CreateIndex(
                name: "IX_proj_safety_incidents_ProjectId_IncidentNumber",
                table: "proj_safety_incidents",
                columns: new[] { "ProjectId", "IncidentNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_proj_submittals_ProjectId_SubmittalNumber",
                table: "proj_submittals",
                columns: new[] { "ProjectId", "SubmittalNumber" },
                unique: true);
        }
