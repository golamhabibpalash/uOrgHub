...
public static class Claims
{
    ...
    public static class Accounts
    {
        ...
        public static class Vouchers { public const string View = "Accounts.Vouchers.View"; public const string Create = "Accounts.Vouchers.Create"; public const string Edit = "Accounts.Vouchers.Edit"; public const string Delete = "Accounts.Vouchers.Delete"; public const string Submit = "Accounts.Vouchers.Submit"; public const string Approve = "Accounts.Vouchers.Approve"; public const string Post = "Accounts.Vouchers.Post"; public const string Reject = "Accounts.Vouchers.Reject"; public const string Export = "Accounts.Vouchers.Export"; public const string Print = "Accounts.Vouchers.Print"; }
    ...
    public static class Procurement
    {
        ...
        public static class PurchaseRequisitions { public const string View = "Procurement.PurchaseRequisitions.View"; public const string Create = "Procurement.PurchaseRequisitions.Create"; public const string Edit = "Procurement.PurchaseRequisitions.Edit"; public const string Delete = "Procurement.PurchaseRequisitions.Delete"; public const string Approve = "Procurement.PurchaseRequisitions.Approve"; public const string Export = "Procurement.PurchaseRequisitions.Export"; public const string Print = "Procurement.PurchaseRequisitions.Print"; }
        public static class RFQs { public const string View = "Procurement.RFQs.View"; public const string Create = "Procurement.RFQs.Create"; public const string Edit = "Procurement.RFQs.Edit"; public const string Delete = "Procurement.RFQs.Delete"; public const string Export = "Procurement.RFQs.Export"; public const string Print = "Procurement.RFQs.Print"; }
